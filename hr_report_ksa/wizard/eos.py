...
class EOS(models.TransientModel):
    ...
    def print_project_report_xls(self):
            ...
            if emp.contract_id and emp.contract_id.date_start:
                ...
                if diff.years > 2:
                    ...
                    if diff.years >= 2 and diff.years <= 5:
                        total_amount_2_5 = emp.contract_id.wage * 33 / 100 * diff.years
                    ...
                    d = {
                        ...
                        'report_date': today,
                        'period': str(diff.years) + " years and " + str(diff.month) + " month and " + str(
                            diff.days) + " days",
        ...
        #     # 'record': record.id,
        # }
        return self.env.ref('hr_report_ksa.report_xls').report_action(self, data=data)
...
class EOS(models.TransientModel):
    ...
    def print_project_report_xls(self):
        ...
        #     # 'record': record.id,
        # }
        return self.env.ref('hr_report_ksa.report2_xls').report_action(self, data=data)
