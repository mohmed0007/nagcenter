...
class Prescription(models.Model):
    ...
    def _compute_delivery(self):
        for rec in self:
            rec.deliverd = True if len(self.picking_ids) else False
    ...
    picking_count = fields.Integer(compute="get_picking_count", string='#Pickings')
    deliverd = fields.Boolean(compute='_compute_delivery', store=True)
